  ...
  return (
    <>
      ...
      <header style={{ marginBottom: '28px' }}>
        <h1 style={{ margin: 0, fontFamily: 'var(--font-jakarta)', fontWeight: 800, fontSize: '27px', letterSpacing: '-0.02em', color: '#241F1B' }}>Bon retour, Arnaud</h1>
        <p style={{ margin: '7px 0 0', fontFamily: 'var(--font-jakarta)', fontWeight: 500, fontSize: '14.5px', color: '#857C71' }}>Voici où en est votre chauffe aujourd&apos;hui.</p>
      </header>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '16px' }}>
        ...
        <div style={{ background: '#EAF6EF', border: '1px solid #CDE9D9', borderRadius: '16px', padding: '20px', display: 'flex', flexDirection: 'column', minHeight: '188px' }}>
          ...
          <div style={{ fontFamily: 'var(--font-jakarta)', fontWeight: 700, fontSize: '15.5px', color: '#1E4634', lineHeight: 1.3, flex: 1 }}>Vérifiez votre<br />adresse email</div>
          <button style={{ marginTop: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '7px', width: '100%', background: '#fff', border: '1px solid #BFE3CF', color: '#1E7A52', borderRadius: '11px', padding: '11px', fontFamily: 'var(--font-jakarta)', fontWeight: 600, fontSize: '13.5px', cursor: 'default' }}>
            <i className="ph ph-check" style={{ fontSize: '16px' }} />Email vérifié
          </button>
        </div>
        ...
        <div style={{ background: '#FDF1E5', border: '1px solid #F4D9BC', borderRadius: '16px', padding: '20px', display: 'flex', flexDirection: 'column', minHeight: '188px' }}>
          ...
          <Link href="/connect" style={{ marginTop: '14px', width: '100%', background: '#E5853C', border: 'none', color: '#fff', borderRadius: '11px', padding: '11px', fontFamily: 'var(--font-jakarta)', fontWeight: 600, fontSize: '13.5px', cursor: 'pointer', boxShadow: '0 2px 6px rgba(207,118,46,0.3)', textDecoration: 'none', display: 'block', textAlign: 'center' }}>Connecter ma boîte</Link>
        </div>
        ...
        <div style={{ background: '#fff', border: '1px solid #ECE7E0', borderRadius: '16px', padding: '20px', display: 'flex', flexDirection: 'column', minHeight: '188px' }}>
          ...
          <Link href="/warmup" style={{ marginTop: '14px', width: '100%', background: '#fff', border: '1px solid #E0DACE', color: '#3A332C', borderRadius: '11px', padding: '11px', fontFamily: 'var(--font-jakarta)', fontWeight: 600, fontSize: '13.5px', cursor: 'pointer', textDecoration: 'none', display: 'block', textAlign: 'center' }}>Définir les paramètres</Link>
        </div>
        ...
        <div style={{ background: '#fff', border: '1px solid #ECE7E0', borderRadius: '16px', padding: '20px', display: 'flex', flexDirection: 'column', minHeight: '188px', opacity: 0.72 }}>
          ...
          <button disabled style={{ marginTop: '14px', width: '100%', background: '#F4EFE7', border: '1px solid transparent', color: '#B0A89D', borderRadius: '11px', padding: '11px', fontFamily: 'var(--font-jakarta)', fontWeight: 600, fontSize: '13.5px', cursor: 'not-allowed' }}>Démarrer</button>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.85fr 1fr', gap: '16px', marginTop: '16px' }}>
        ...
        <div style={{ background: '#fff', border: '1px solid #ECE7E0', borderRadius: '16px', padding: '26px', boxShadow: '0 1px 2px rgba(40,28,16,0.04)', display: 'flex', flexDirection: 'column' }}>
          ...
          <p style={{ margin: '0 0 20px', fontFamily: 'var(--font-jakarta)', fontWeight: 500, fontSize: '13.5px', color: '#857C71', lineHeight: 1.55, flex: 1 }}>Une question sur la délivrabilité ou la configuration ? Notre équipe répond en moins de 2 h.</p>
          <button style={{ width: '100%', background: '#241F1B', border: 'none', color: '#fff', borderRadius: '11px', padding: '12px', fontFamily: 'var(--font-jakarta)', fontWeight: 600, fontSize: '13.5px', cursor: 'pointer', marginBottom: '9px' }}>Contacter le support</button>
